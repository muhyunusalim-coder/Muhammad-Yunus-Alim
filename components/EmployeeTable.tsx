                            ...
                            {confirmDeleteId === emp.id ? (
                              <div className="flex items-center gap-1 animate-in fade-in zoom-in duration-200">
                                <button 
                                  ...
                                  className="px-2 py-1 text-[10px] font-bold bg-rose-500 text-white rounded-md hover:bg-rose-600 shadow-sm"
                                >
                                  Ya
                                </button>
                                <button 
                                  ...
                                  className="px-2 py-1 text-[10px] font-bold bg-slate-100 text-slate-600 rounded-md hover:bg-slate-200"
                                >
                                  Batal
                                </button>
                              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-50 rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] animate-in scale-in-95 duration-200 flex flex-col overflow-hidden">
            ...
            <div className="p-6 md:p-8 space-y-6 flex-1 bg-white overflow-y-auto">
              ...
              {/* Section 3: Salary History removed */}
